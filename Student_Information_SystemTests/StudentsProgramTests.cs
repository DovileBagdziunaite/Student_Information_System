...
namespace Student_Information_System.Tests
{
    [TestClass]
    public class UnitTest1
    {
        ...
        public void OnInit()
        {
            _options = new DbContextOptionsBuilder<StudentsContext>()
                .UseInMemoryDatabase(databaseName: "Student_Information_System" + Guid.NewGuid())
            .Options;
            _context = new StudentsContext(_options);
